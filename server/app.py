...
def run_measurement():
    try:
        ...
        # image_name, image_path = volume_measure.get_latest_image_url()
        # # Upload the image and perform measurement
        # destination_image_path = "image_result/" + image_name
        # volume_measure.upload_image(image_path, destination_image_path)
        # result_image_path = volume_measure.main(image_path, "calibration/cs_(8, 5)_rd_3_te_0.08_rs_3.npz", image_name)
...
def main(fname, npz, img_name):
    ...
    # print("TEST: ")
    # print("imgpoints")
    # print(a.object_vertexes[0])  # imgpoints
    # print("objpoints", a.objp)
    # ret, rvecs, tvecs = cv2.solvePnP(a.objp, a.object_vertexes, a.camera_matrix, a.dist)
    # print(tvecs[2][0])
    # print(objp)
    #
    ###
    # TEST2
    # ret, rvecs, tvecs = cv2.solvePnP(a.objp, a.pts1, a.camera_matrix, a.dist)
    ...
    bucket = storage.bucket()
    blob = bucket.blob("image_result/" + img_name)
...
def get_latest_image_url():
    ...
    npz_name = "cs_(8, 5)_rd_3_te_0.08_rs_3.npz"
    npz_path = "calibration/" + npz_name
    main(image_path, npz_path, img_name)

    return "gs://cj-2023-pororo.appspot.com/image_result/" + img_name
